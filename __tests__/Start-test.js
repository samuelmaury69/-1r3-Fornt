...
import ConnectedStart from '../screens/Start';
...
describe('Start Component', () => {
       ...
       beforeEach(() => {
            store = mocklanguage({answer: [{"name": "Español","code": "es_es","text": "{ \"Enter\":\"Entrar\", \"Check_in\":\"Registrarse\", \"User\":\"Usuario\", \"Password\":\"Contraseña\", \"Dont_have\":\"No tienes una cuenta?\", \"Forgot\":\"He olvidado mi contraseña\", \"Reestablish\":\"Reestablecer contraseña \", \"Reestablish_message\":\"Introduce el email con el que te has registrado. Te enviaremos un correo para que escoger una nueva contraseña\", \"Return\":\"Volver\", \"Sign_up\":\"Registrate\", \"Enter_user\":\"Debe ingresar usuario\", \"Enter_password\":\"Debe ingresar contraseña\", \"Invalid\":\"Contraseña o usuario inválido\", \"Mail\":\"Correo\", \"Address\":\"Dirección\", \"Photo\":\"Tomar foto\"}"},
            ...
            wrapper = shallow(<ConnectedStart store={store}/>).childAt(0).dive();
       })
